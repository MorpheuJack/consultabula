  ...
  return (
    <Link href={`/shop/${product.id}`} className="flex flex-col h-full group">
      <GlareHover
        ...
        glareSize={200}
      >
        <Card className="flex flex-col h-full w-full overflow-hidden rounded-lg shadow-lg bg-card text-card-foreground transition-shadow duration-300 group-hover:shadow-xl group-hover:-translate-y-1">
